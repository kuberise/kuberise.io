...
read -p "This script will remove the $PLATFORM_NAME platform from the $CONTEXT Kubernetes context. It will also delete multiple namespaces. Are you sure you want to continue? (yes/no): " answer
