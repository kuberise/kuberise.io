...
namespaces=("argocd" "cloudnative-pg" "keycloak" "backstage" "ingress-nginx-internal" "ingress-nginx-external" "monitoring" "ingresses" "gitea" "frontend-https" "metallb" "raw" "show-env" "cert-manager")
